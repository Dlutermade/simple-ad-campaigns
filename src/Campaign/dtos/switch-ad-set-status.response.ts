...
export class SwitchAdSetStatusResponse {
  @ApiProperty({
    type: String,
    description: 'ID of the updated ad set',
  ...
  @ApiProperty({
    type: String,
    description: 'Name of the updated ad set',
  ...
  constructor(partial: Partial<SwitchAdSetStatusResponse>) {
